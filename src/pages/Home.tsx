...
import MixpanelImg from '../assets/images/Mixpanel.jpg'; 
import ExcelImg from '../assets/images/Excel.png'; // adjust extension if needed
import AWSImg from '../assets/images/AWS.webp';     // adjust extension if needed
import PPTImg from '../assets/images/PPT.png';     // adjust extension if needed
            ...
            >
              <div className="text-center mb-10">
                ...
                <h2 className="text-lg sm:text-xl md:text-2xl font-medium text-muted-foreground whitespace-nowrap">
                  Product Manager | Driving SaaS & AI Products from Concept to Launch
                </h2>
              </div>
              <p className="text-lg mb-8 max-w-2xl" style={{ lineHeight: 1.4 }}>
                <b style={{ fontSize: "1.2em", whiteSpace: "nowrap" }}>
                  I build products that cut through noise and create real change
                </b>
                <br />
                ...
                a Product Manager who turns raw ideas into market-ready products.
I lead end-to-end lifecycles for SaaS and AI platforms, driving strategy, shaping roadmaps, and steering cross-functional teams toward one goal: <b>impact.</b>
                ...
                I thrive where there’s no blueprint, where clarity has to be created, and bold decisions shape what gets built.
                <br />
                ...
                <b style={{ lineHeight: 1.5, display: 'block' }}>
                  Vision. Execution. Impact. That’s the work I do
                </b>
              </p>
        ...
        <div className="container-custom">
          ...
          <div className="mt-12">
            ...
            <div className="grid grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6 max-w-4xl mx-auto">
              ...
              <div className="flex flex-col items-center p-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                <img src={MixpanelImg} alt="Mixpanel" className="w-12 h-12 mb-2" />
              ...
              <div className="flex flex-col items-center p-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                <img src={AWSImg} alt="AWS" className="w-12 h-12 mb-2" />
              ...
              <div className="flex flex-col items-center p-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                <img src={PPTImg} alt="PowerPoint" className="w-12 h-12 mb-2" />
                <span className="text-sm font-medium">PowerPoint</span>
              </div>
              
              <div className="flex flex-col items-center p-4 bg-white dark:bg-gray-800 rounded-lg shadow-sm hover:shadow-md transition-shadow">
                <img src={ExcelImg} alt="Excel" className="w-12 h-12 mb-2" />
